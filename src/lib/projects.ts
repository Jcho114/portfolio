...
const appdevclub: Project = {
	...
	description: 'Revamped the club website to professionally showcase club sponsors, projects, and upcoming events.',
...
const gdit: Project = {
	...
	description: 'Worked as part of the UMD App Dev to build a full stack scavenger hunt application for GDIT.',
	thumbnail: '',
	role: 'Student Software Engineer',
